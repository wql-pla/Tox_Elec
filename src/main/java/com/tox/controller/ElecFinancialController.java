...
import com.tox.utils.wxtox.WXPayConfigImpl;
...
public class ElecFinancialController {
	
	
	private static final Logger logger = LoggerFactory.getLogger(ElecFinancialController.class);
	...
	private ElecFinancialService FinancialService;
	   ...
	   private WXPayConfigImpl config;
	    ...
	    public ElecFinancialController() throws Exception {
	    ...
	    Map<String, Object> doUnifiedOrder_pledge(HttpServletRequest req,@RequestBody WxinInfo info) throws Exception {
	        ...
	        data.put("notify_url","http://elec.toxchina.com/ToxElec_2/financial/notify");
